...
class FeatureRegistry {
  ...
  async discoverFeatures() {
    ...
    try {
      ...
      logger.info("[FeatureRegistry] Discovering features", {
        featuresDir,
        directoryCount: featureDirs.length,
      });
      logger.debug("[FeatureRegistry] Found directories", {
      ...
      for (const featureDir of featureDirs) {
        ...
        try {
          ...
          if (this.validateManifest(manifest)) {
            ...
            logger.info("[FeatureRegistry] Registered feature", {
              key: manifest.key,
              name: manifest.name,
            });
          } else {
          ...
          logger.debug("[FeatureRegistry] No manifest found", {
            featureDir,
            error: error.message,
          });
        }
      ...
      logger.error("[FeatureRegistry] Error discovering features", {
        error: error.message,
        stack: error.stack,
      });
    }
